...
if (params === 'none') window.location = 'index.html?type=qmttsaloud.html';
type =  params.get('type');
type = type ? type : 'qmttsaloud.html';
...
<a href='qmttsaloud.html?title=${a[1]}&lang=${a[0]}'>qmttsaloud.html?title=${a[1]}&lang=${a[0]}</a></li>`;
