let myGroup, myBook;
const book = {};
const lastBookInGroupStored = g => `lastMarkdownInGroup${g}`
const lastBookStored = `lastMarkdown`
let lastBook;
let lastGroup;
...
const deviceType = getDeviceType();
  ...
  lastBook = lastBook ? lastBook : 'Bot_macros';
...
const ReadAloud = () => { 
  ...
  window.location = `mark.html?md=${mdPath}`; 
}
